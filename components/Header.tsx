    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-6">
          <a
            href="#home"
            className="text-foreground hover:text-desert-gold-600 transition-colors"
          >
          ...
          <a
            ...
            className="text-foreground hover:text-desert-gold-600 transition-colors"
          >
            {messages.navigation.livingGuide}
          </a>
          <a
            href="#tools"
            className="text-foreground hover:text-desert-gold-600 transition-colors"
          >
            {messages.navigation.tools}
          </a>
          <a
            href="#tourism"
            className="text-foreground hover:text-desert-gold-600 transition-colors"
          >
            {messages.navigation.tourism}
          </a>
          <a
            href="#community"
            className="text-foreground hover:text-desert-gold-600 transition-colors"
          >
            {messages.navigation.community}
          </a>
        </nav>
...
function LanguageSwitch() {
  ...
  const handleLanguageChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    const newLocale = e.target.value as "en" | "zh";
    setLocale(newLocale);
